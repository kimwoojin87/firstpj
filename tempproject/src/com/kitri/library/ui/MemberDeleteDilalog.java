...
public class MemberDeleteDilalog extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					MemberDeleteDilalog frame = new MemberDeleteDilalog();
	...
	public MemberDeleteDilalog() {
		...
		JLabel lbWarn = new JLabel("\uC815\uB9D0\uB85C xx \uB2D8\uC744 \uC0AD\uC81C\uD558\uC2DC\uACA0\uC2B5\uB2C8\uAE4C?");
